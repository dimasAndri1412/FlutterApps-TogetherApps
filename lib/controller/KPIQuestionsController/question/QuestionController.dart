 ...
 class Questioncontroller {
  Future<List<QuestionModel>> getQuestions(int positionId) async {
    try {
      ...
      Uri.parse("http://192.168.100.84/FlutterAPI/KPI/getQuestions.php"),
        body: {
  ...
  addQuestion(int positionId) async{
    try {
      final response = await http.post(
        Uri.parse("http://192.168.100.84/FlutterAPI/KPI/addQuestions.php"),
        body: {
          'id_position': positionId.toString(),
  ...
  editQuestion(int questionId, String questionText) async {
    try {
      final response = await http.post(
        Uri.parse("http://192.168.100.84/FlutterAPI/KPI/editQuestions.php"),
        body: {
