...
class PDFGenerator_MSDOuser extends StatelessWidget {
  // final AdminApprovalPaidLeaveModel getUserDetail;
  final MemberListPaidLeave getUserDetail;
  PDFGenerator_MSDOuser({super.key, required this.getUserDetail});
  ...
  Future<Uint8List> GeneratePDF() async {
    ...
    final Uint8List backgroundImage =
        await loadAssetImage('assets/images/BIT-Logo.png');
            ...
            children: [
              ...
              pw.Column(
                  ...
                  children: [
                    pw.Row(children: [
                      pw.Container(
                          child: pw.Text(getUserDetail.reqNo,
                              style: pw.TextStyle(
                                fontSize: 10,
                              ))),
                      pw.Spacer(),
                    ...
                    pw.Container(
                        ...
                        child: pw.Column(children: [
                          pw.Row(children: [
                            ...
                            pw.Text(getUserDetail.username,
                                style: pw.TextStyle(fontSize: 11))
                          ]),
                          pw.Row(children: [
                            pw.Text("Jabatan : ",
                                style: pw.TextStyle(fontSize: 11)),
                            pw.Text(getUserDetail.position,
                                style: pw.TextStyle(fontSize: 11))
                          ]),
                          pw.Row(children: [
                            pw.Text("Departemen : ",
                                style: pw.TextStyle(fontSize: 11)),
                            pw.Text(getUserDetail.departement,
                                style: pw.TextStyle(fontSize: 11))
                          ]),
                        ])),
                    pw.Container(
                      ...
                      child: pw.Row(children: [
                        pw.Text("Mengajukan permohonan untuk: : ",
                            style: pw.TextStyle(fontSize: 11)),
                        pw.Text(getUserDetail.reason_leave,
                            style: pw.TextStyle(
                                fontSize: 11,
                      ...
                      child: pw.RichText(
                        text: pw.TextSpan(
                          children: [
                            pw.TextSpan(
                              text:
                                  'Nama yang dapat dihubungi selama cuti/izin meninggalkan pekerjaan:\n',
                              style: pw.TextStyle(
                                fontSize: 11,
                              ),
                            ),
                    ...
                    pw.Container(
                        ...
                        child: pw.Padding(
                            padding:
                                pw.EdgeInsets.only(top: 10, left: 5, right: 10),
                            child: pw.Column(
                                crossAxisAlignment: pw.CrossAxisAlignment.start,
                                children: [
                                  pw.Text("Untuk dicek oleh petugas HC : ",
                                      style: pw.TextStyle(
                                          fontSize: 11,
                                          fontWeight: pw.FontWeight.bold)),
                                  ...
                                  pw.Row(children: [
                                    pw.Padding(
                                      ...
                                      child: pw.Text("Sisa Cuti Periode lalu ",
                                          style: pw.TextStyle(
                                            fontSize: 11,
                                          )),
                                    ),
