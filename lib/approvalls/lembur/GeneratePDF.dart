...
class GeneratePDFOvertime extends StatelessWidget {
  AdminApprovalOvertimeModel getData;
   GeneratePDFOvertime({super.key,
              ...
              child: pw.Column(
                  children: [
                    ...
                    pw.Container(
                        ...
                        child: pw.Text("Diperintahkan kepada Pekerja tersebut di bawah ini :")
                    ),
                    pw.Table(
                        ...
                        children: [
                          pw.TableRow(children :[
                            ...
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(4),
                              child: pw.Text('Tanggal / Bulan',  textAlign: pw.TextAlign.center),
                            ),
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(4),
                          ...
                          pw.TableRow(children :[
                            ...
                            pw.Container(
                              width: 80,
                              padding: pw.EdgeInsets.all(4),
                              child: pw.Text(getData.full_name, textAlign: pw.TextAlign.center),
                            ),
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(4),
                              child: pw.Text(getData.department,  textAlign: pw.TextAlign.center),
                            ),
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(4),
                              child: pw.Text(getData.start_date,  textAlign: pw.TextAlign.center),
                            ),
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(4),
                              child: pw.Text('${getData.start_time} s/d ${getData.end_time}',  textAlign: pw.TextAlign.center),
                            ),
                            pw.Padding(
                              padding: const pw.EdgeInsets.all(2),
                    ...
                    pw.Container(
                      ...
                      child: pw.RichText(
                        text: pw.TextSpan(
                          children: [
                            pw.TextSpan(
                              text: 'Untuk melaksanakan kerja lembur pada waktu sebagaimana tercantum pada kolom di atas, dengan tugas sbb :\n',
                              style: pw.TextStyle(
                                fontSize: 11,
                              ),
                            ),
                    ...
                    pw.Container(
                        ...
                        child: pw.Column(
                            children: [
                              pw.Text("Pengawasan pelaksanaan kerja lembur diserahkan kepada :"),
                              pw.Container(
                                  alignment: pw.Alignment.centerLeft,
                                  width: 300,
                                  child: pw.Row(
                    ...
                    pw.Container(
                        margin: pw.EdgeInsets.only(top: 20, left: 3),
                        alignment: pw.Alignment.centerLeft,
                        child: pw.Text("Demikian Surat Perintah Kerja Lembur ini dibuat dan untuk dilaksanakan dengan sebaik-baiknya dengan penuh rasa tanggung jawab.")
                    ),
                    pw.Padding(
