                  ...
                  children: [ 
                    ...
                    pw.TableRow(children :[
                      ...
                      pw.Container(
                        width: 80,
                        padding: pw.EdgeInsets.all(4),
                        child: pw.Text("Rarazu", textAlign: pw.TextAlign.center),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4),
                        child: pw.Text('DIIO',  textAlign: pw.TextAlign.center),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4),
                        child: pw.Text('10 Jun 2024',  textAlign: pw.TextAlign.center),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(4),
                        child: pw.Text('17:00 s/d 20:00',  textAlign: pw.TextAlign.center),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(2),
                        child:  pw.Text('Di Gd. CP BRI Lt 5',  
                          textAlign: pw.TextAlign.center
                        ),
                      ),
                    ]),
                  ...
                  child: pw.RichText(
                    text: pw.TextSpan(
                      children: [
                        ...
                        pw.TextSpan(
                          text: 'a. Melakukan Support Project MSDO',
                          style: pw.TextStyle(
                            fontSize: 11, 
