    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Form(
            //BIRTHDATE FILED
            key: addUserField.birthdateKeys,
            child: TextFormField(
        ...
        Container(
          ...
          child: Form(
              key: addUserField.projectOption,
        ...
        Container(
          ...
          child: Form(
            ...
            key: addUserField.confirmpassKeys,
            child: TextFormField(
              obscureText: passHiding,
              keyboardType: TextInputType.emailAddress,
              decoration: InputDecoration(
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Password can not empty!';
                } else if (value != addUserField.passKeys) {
